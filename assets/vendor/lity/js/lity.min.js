...
!(function (a, b) {
  ...
  function c(a) {
    ...
    return (
      G && a.length
        ? (a.one(G, b.resolve), setTimeout(b.resolve, 500))
        : b.resolve(),
      b.promise()
    );
  }
  ...
  function m() {
    return w.documentElement.clientHeight
  ...
  function q(a) {
    1 === A.unshift(a) &&
      (z.addClass("lity-active"), x.on({ resize: p, keydown: n })),
      b("body > *")
        .not(a.element())
  ...
  function r(a) {
    ...
    a.element().attr(B, "true"),
      1 === A.length &&
        (z.removeClass("lity-active"), x.off({ resize: p, keydown: n })),
    ...
    (e = b.extend({}, E, e)),
      ...
      (l.close = function () {
        if (n && !o) {
          ...
          if (
            g &&
            (w.activeElement === j[0] || b.contains(j[0], w.activeElement))
          )
            try {
              g.focus();
            } catch (a) {}
